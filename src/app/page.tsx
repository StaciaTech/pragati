    ...
    <main className="flex min-h-screen w-full">
      ...
      <div className="hidden lg:flex flex-1 bg-secondary/50 p-8 items-center justify-center relative overflow-hidden">
          <div className="absolute inset-0 -z-10 h-full w-full bg-background bg-[radial-gradient(hsl(var(--primary)/0.1)_1px,transparent_1px)] bg-[size:16px_16px]"></div>
           <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-gray-400/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute -top-40 -left-40 w-96 h-96 bg-gray-400/5 rounded-full blur-3xl animate-pulse"></div>
