  ...
  return (
    <main className="flex min-h-screen w-full items-center justify-center bg-background lg:grid lg:grid-cols-2">
      ...
      <div className="relative hidden h-full flex-col bg-primary p-10 text-primary-foreground dark:border-r lg:flex overflow-hidden">
          ...
          <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-secondary/50 blur-3xl animate-wavy-bounce-1"></div>
          <div className="absolute -bottom-32 -right-32 h-96 w-96 rounded-full bg-accent/50 blur-3xl animate-wavy-bounce-2"></div>
