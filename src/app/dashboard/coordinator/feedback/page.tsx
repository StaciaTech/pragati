...
export default function IdeaFeedbackPage() {
    ...
    const assignedIdeasWithFeedback = MOCK_IDEAS.filter(idea =>
      idea.ttcAssigned === userTTC.id && idea.feedback
    );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Review ideas you have provided feedback for.</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <TableBody>
            {filteredIdeas.map((idea) => (
             ...
             {filteredIdeas.length === 0 && (
                <TableRow>
                    <TableCell colSpan={5} className="text-center">No ideas with feedback found.</TableCell>
                </TableRow>
             )}
          </TableBody>
        </Table>
