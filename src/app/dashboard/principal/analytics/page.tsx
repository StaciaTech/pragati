    ...
    <div className="space-y-6">
      <Card className="w-full bg-gradient-to-br from-primary to-primary/80 text-primary-foreground shadow-lg border-0 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <CardHeader>
            <CardTitle className="text-3xl text-white">College Analytics</CardTitle>
            <CardDescription className="text-primary-foreground/80">View analytics and performance metrics for your college.</CardDescription>
          </CardHeader>
        </div>
      </Card>
